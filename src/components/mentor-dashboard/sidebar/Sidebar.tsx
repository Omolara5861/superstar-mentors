...
const Sidebar = () => {
    ...
    const links = [
        { href: '/mentor-dashboard', src: '/dashboard/dashboard.svg', alt: 'Dashboard Icon', text: 'Overview' },
        ...
        { href: '/mentor-dashboard/help-center', src: '/dashboard/help.svg', alt: 'Help Icon', text: 'Help' }
    ];
